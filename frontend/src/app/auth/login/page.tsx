  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#121212] p-4">
      ...
      <div className="w-full max-w-md bg-[#1a1a1a] rounded-lg shadow-lg p-6">
        ...
        {loginError && (
          <Message severity="error" text={loginError} className="w-full mb-4" />
        )}
        ...
        <form onSubmit={handleLogin} className="space-y-4" noValidate>
          <div className="flex flex-col gap-1">
            <span className="p-float-label">
              <InputText
                ...
                className={classNames('w-full bg-[#222222] border-[#333333]', {
            ...
            {errors.email && (
              <small id="email-error" className="p-error text-xs">{errors.email}</small>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {errors.password && (
              <small id="password-error" className="p-error text-xs">{errors.password}</small>
            )}
          </div>
          ...
          <Button
            ...
            iconPos="right"
            className="w-full bg-[#daec46] text-black hover:bg-[#c5d73e] font-medium px-[8.5rem]"
            disabled={loading}
          />
        </form>
